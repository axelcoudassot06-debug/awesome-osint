...
* * [Sentinelle Pulse Copilot](https://copilot.sentinellepulse.com) - French-language OSINT directory: 1105 tools verified daily in 37 categories, each with a bilingual FR/EN description, plus an investigation planner that turns a starting point (email, username, photo, phone, domain) into an ordered plan with pre-filled queries. Free, no account.
